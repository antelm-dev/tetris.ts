import { Piece, PIECES_SHAPES, type Field, type PieceName, type PlaceResult } from '../engine'
import type { Orientation } from '../engine/const'
...
function shapeAtOrientation(name: PieceName, rotation: Orientation): number[][] {
